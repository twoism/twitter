  ...
  class Client
    ...
    def activity_about_me(options={})
      ...
      response[:body].map do |action|
        Twitter::ActionFactory.from_response(:body => action, :response_headers => response[:response_headers])
      end
    end
    ...
    def blocking(options={})
      ...
      response[:body].map do |user|
        Twitter::User.from_response(:body => user, :response_headers => response[:response_headers])
      end
    end
    ...
    def direct_messages_received(options={})
      ...
      response[:body].map do |direct_message|
        Twitter::DirectMessage.from_response(:body => direct_message, :response_headers => response[:response_headers])
      end
    end
    ...
    def favorites(*args)
      ...
      response[:body].map do |status|
        Twitter::Status.from_response(:body => status, :response_headers => response[:response_headers])
      end
    end
    ...
    def languages(options={})
      ...
      response[:body].map do |language|
        Twitter::Language.from_response(:body => language, :response_headers => response[:response_headers])
      end
    end
    ...
    def lists_subscribed_to(*args)
      ...
      response[:body].map do |list|
        Twitter::List.from_response(:body => list, :response_headers => response[:response_headers])
      end
    end
    ...
    def local_trends(woeid=1, options={})
      ...
      response[:body].first['trends'].map do |trend|
        Twitter::Trend.from_response(:body => trend, :response_headers => response[:response_headers])
      end
    end
    ...
    def trend_locations(options={})
      ...
      response[:body].map do |place|
        Twitter::Place.from_response(:body => place, :response_headers => response[:response_headers])
      end
    end
    ...
    def saved_searches(*args)
      ...
      if args.empty?
        ...
        response[:body].map do |saved_search|
          Twitter::SavedSearch.from_response(:body => saved_search, :response_headers => response[:response_headers])
        end
      else
        args.flatten.threaded_map do |id|
    ...
    def suggestions(*args)
      ...
      if slug = args.pop
        ...
        response[:body].map do |suggestion|
          Twitter::Suggestion.from_response(:body => suggestion, :response_headers => response[:response_headers])
        end
      end
    end
    ...
    def trends_daily(date=Date.today, options={})
      ...
      response[:body]['trends'].each do |key, value|
        trends[key] = []
        value.each do |trend|
          trends[key] << Twitter::Trend.from_response(:body => trend, :response_headers => response[:response_headers])
        end
      end
      trends
    end
    ...
    def recommendations(*args)
      ...
      response[:body].map do |recommendation|
        Twitter::User.from_response(:body => recommendation['user'], :response_headers => response[:response_headers])
      end
    end
