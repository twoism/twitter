...
describe Twitter::Status do
  ...
  describe "#created_at" do
    it "returns a Time when set" do
      status = Twitter::Status.new(:body => {'created_at' => "Mon Jul 16 12:59:01 +0000 2007"})
  ...
  describe "#favoriters_count" do
    it "returns the count of favoriters when favoriters_count is set" do
      status = Twitter::Status.new(:body => {'favoriters_count' => '1'})
  ...
  describe "#full_text" do
    it "returns the text of a status" do
      status = Twitter::Status.new(:body => {'text' => 'BOOSH'})
      status.full_text.should be_a String
      status.full_text.should eq "BOOSH"
    end
    it "returns the text of a status without a user" do
      status = Twitter::Status.new(:body => {'text' => 'BOOSH', 'retweeted_status' => {'text' => 'BOOSH'}})
      status.full_text.should be_a String
      status.full_text.should eq "BOOSH"
    end
    it "returns the full text of a retweeted status" do
      status = Twitter::Status.new(:body => {'retweeted_status' => {'text' => 'BOOSH', 'user' => {'screen_name' => 'sferik'}}})
      status.full_text.should be_a String
  ...
  describe "#geo" do
    it "returns a Twitter::Point when set" do
      status = Twitter::Status.new(:body => {'geo' => {'type' => 'Point'}})
  ...
  describe "#hashtags" do
    it "returns an Array of Entity::Hashtag when entities are set" do
      ...
      hashtags = Twitter::Status.new(:body => {'entities' => {'hashtags' => hashtags_hash}}).hashtags
  ...
  describe "#media" do
    it "returns media" do
      media = Twitter::Status.new(:body => {'entities' => {'media' => [{'type' => 'photo'}]}}).media
  ...
  describe "#metadata" do
    it "returns a User when user is set" do
      metadata = Twitter::Status.new(:body => {'metadata' => {}}).metadata
  ...
  describe "#oembed" do
    before do
      ...
      @status = Twitter::Status.new(:body => {'id' => 25938088801})
    end
  ...
  describe "#place" do
    it "returns a Twitter::Place when set" do
      status = Twitter::Status.new(:body => {'place' => {}})
  ...
  describe "#repliers_count" do
    it "returns the count of favoriters when repliers_count is set" do
      status = Twitter::Status.new(:body => {'repliers_count' => '1'})
  ...
  describe "#retweeters_count" do
    it "returns the count of favoriters when retweet_count is set" do
      status = Twitter::Status.new(:body => {'retweet_count' => '1'})
    ...
    it "returns the count of favoriters when retweeters_count is set" do
      status = Twitter::Status.new(:body => {'retweeters_count' => '1'})
      status.retweeters_count.should be_an Integer
      status.retweeters_count.should eq 1
    end
    it "returns nil when not set" do
  ...
  describe "#retweeted_status" do
    it "returns a Status when retweeted_status is set" do
      status = Twitter::Status.new(:body => {'retweeted_status' => {'text' => 'BOOSH'}})
  ...
  describe "#urls" do
    it "returns an Array of Entity::Url when entities are set" do
      ...
      urls = Twitter::Status.new(:body => {'entities' => {'urls' => urls_hash}}).urls
  ...
  describe "#user" do
    it "returns a User when user is set" do
      user = Twitter::Status.new(:body => {'user' => {}}).user
    ...
    it "has a status when status is set" do
      user = Twitter::Status.new(:body => {'text' => 'Tweet text.', 'user' => {}}).user
  ...
  describe "#user_mentions" do
    it "returns an Array of Entity::User_Mention when entities are set" do
      ...
      user_mentions = Twitter::Status.new(:body => {'entities' => {'user_mentions' => user_mentions_hash}}).user_mentions
