...
describe Twitter::List do
  ...
  describe "#==" do
    it "returns true when ids and classes are equal" do
      list = Twitter::List.new(:body => {'id' => 1})
      other = Twitter::List.new(:body => {'id' => 1})
    ...
    it "returns false when ids are not equal" do
      list = Twitter::List.new(:body => {'id' => 1})
      other = Twitter::List.new(:body => {'id' => 2})
      (list == other).should be_false
    end
  end
  ...
  describe "#created_at" do
    it "returns a Time when created_at is set" do
      user = Twitter::List.new(:body => {'created_at' => "Mon Jul 16 12:59:01 +0000 2007"})
  ...
  describe "#user" do
    it "returns a User when user is set" do
      user = Twitter::List.new(:body => {'user' => {}}).user
