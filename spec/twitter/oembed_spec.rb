...
describe Twitter::OEmbed do
  describe "#author_url" do
    it "returns the author's url" do
      oembed = Twitter::OEmbed.new(:body => {'author_url' => 'https://twitter.com/sferik'})
  ...
  describe "#author_name" do
    it "returns the author's name" do
      oembed = Twitter::OEmbed.new(:body => {'author_name' => 'Erik Michaels-Ober'})
  ...
  describe "#cache_age" do
    it "returns the cache_age" do
      oembed = Twitter::OEmbed.new(:body => {'cache_age' => '31536000000'})
  ...
  describe "#height" do
    it "returns the height" do
      oembed = Twitter::OEmbed.new(:body => {'height' => 200})
  ...
  describe "#html" do
    it "returns the html" do
      oembed = Twitter::OEmbed.new(:body => {'html' => '<blockquote>all my <b>witty tweet</b> stuff here</blockquote>'})
  ...
  describe "#provider_name" do
    it "returns the provider_name" do
      oembed = Twitter::OEmbed.new(:body => {'provider_name' => 'Twitter'})
  ...
  describe "#provider_url" do
    it "returns the provider_url" do
      oembed = Twitter::OEmbed.new(:body => {'provider_url' => 'http://twitter.com'})
  ...
  describe "#type" do
    it "returns the type" do
      oembed = Twitter::OEmbed.new(:body => {'type' => 'rich'})
  ...
  describe "#width" do
    it "returns the width" do
      oembed = Twitter::OEmbed.new(:body => {'width' => 550})
  ...
  describe "#url" do
    it "returns the url" do
      oembed = Twitter::OEmbed.new(:body => {'url' => 'https://twitter.com/twitterapi/status/133640144317198338'})
  ...
  describe "#version" do
    it "returns the version" do
      oembed = Twitter::OEmbed.new(:body => {'version' => '1.0'})
