...
describe Twitter::DirectMessage do
  ...
  describe "#==" do
    it "returns true when ids and classes are equal" do
      direct_message = Twitter::DirectMessage.new(:body => {'id' => 1})
      other = Twitter::DirectMessage.new(:body => {'id' => 1})
    ...
    it "returns false when ids are not equal" do
      direct_message = Twitter::DirectMessage.new(:body => {'id' => 1})
      other = Twitter::DirectMessage.new(:body => {'id' => 2})
      (direct_message == other).should be_false
    end
  end
  ...
  describe "#created_at" do
    it "returns a Time when created_at is set" do
      direct_message = Twitter::DirectMessage.new(:body => {'created_at' => "Mon Jul 16 12:59:01 +0000 2007"})
  ...
  describe "#recipient" do
    it "returns a User when recipient is set" do
      recipient = Twitter::DirectMessage.new(:body => {'recipient' => {}}).recipient
  ...
  describe "#sender" do
    it "returns a User when sender is set" do
      sender = Twitter::DirectMessage.new(:body => {'sender' => {}}).sender
