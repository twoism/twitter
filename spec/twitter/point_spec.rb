...
describe Twitter::Point do
  ...
  before do
    @point = Twitter::Point.new(:body => {'coordinates' => [-122.399983, 37.788299]})
  end

  describe "#==" do
    it "returns true when coordinates are equal" do
      other = Twitter::Point.new(:body => {'coordinates' => [-122.399983, 37.788299]})
      (@point == other).should be_true
    end
    it "returns false when coordinates are not equal" do
      other = Twitter::Point.new(:body => {'coordinates' => [37.788299, -122.399983]})
