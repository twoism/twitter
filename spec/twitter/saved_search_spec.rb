...
describe Twitter::SavedSearch do
  ...
  describe "#==" do
    it "returns true when ids and classes are equal" do
      saved_search = Twitter::SavedSearch.new(:body => {'id' => 1})
      other = Twitter::SavedSearch.new(:body => {'id' => 1})
    ...
    it "returns false when ids are not equal" do
      saved_search = Twitter::SavedSearch.new(:body => {'id' => 1})
      other = Twitter::SavedSearch.new(:body => {'id' => 2})
      (saved_search == other).should be_false
    end
  end
  ...
  describe "#created_at" do
    it "returns a Time when created_at is set" do
      saved_search = Twitter::SavedSearch.new(:body => {'created_at' => "Mon Jul 16 12:59:01 +0000 2007"})
